...
# $Id: grab-machine.pl,v 1.1 2009/04/07 23:59:32 ppollard Exp $
...
my %table;
store \%table, 'changes.store';
store \%table, 'skipped.store';


my $changes = retrieve('changes.store') or die "CAN'T OPEN CHANGES FILE.";
my $skipped = retrieve('skipped.store') or die "CAN'T OPEN SKIP FILE.";
